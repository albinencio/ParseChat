...
1. How to add a "Log out" feature.
2. Hot to refresh less often, only under user's request.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://github.com/albinencio/ParseChat/blob/master/ParseChatDemo.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

The most challenging part was understanding how Parse works, and especially implementing the query to ask for the messages from the database.
